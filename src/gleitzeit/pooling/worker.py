...
from gleitzeit.core.errors import TaskError, TaskTimeoutError, ErrorCode, SystemError
...
class ProviderWorker:
    ...
    async def _execute_task(self, task_id: str, task_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            # Use execute_with_stats to get preprocessing benefits
            if hasattr(self.provider, 'execute_with_stats'):
                result = await asyncio.wait_for(
                    self.provider.execute_with_stats(
                ...
                # Fallback for providers without execute_with_stats
                result = await asyncio.wait_for(
