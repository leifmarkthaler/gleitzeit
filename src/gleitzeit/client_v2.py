...
class GleitzeitClient:
    ...
    async def _register_native_providers(self, registry: ProtocolProviderRegistry) -> None:
        ...
        try:
            ...
            python_provider = PythonProvider("python-provider", allow_local=True)
        ...
        try:
            ...
            mcp_provider = SimpleMCPProvider("mcp-provider")
        ...
        try:
            ...
            template_provider = TemplateProvider("template-provider", execution_engine=self._execution_engine)
