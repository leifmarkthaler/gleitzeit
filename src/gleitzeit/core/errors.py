...
class HandlerExecutionError(TaskError):
    """
    Handler execution error - wraps handler-specific errors.
    This should be used for all handler-level failures (Python, HTTP, SQL, etc.)
    where the handler itself executed but the underlying operation failed.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Always use TASK_EXECUTION_FAILED code for handler errors
        # Extract data from kwargs to avoid duplicate keyword argument
