"""
Fixed test module for BatchProcessor
...
@pytest.mark.unit
class TestBatchProcessorFixed:
    """Fixed unit tests for BatchProcessor"""
    ...
    def test_create_batch_workflow_creates_parallel_tasks(self, batch_processor, sample_files):
        ...
        for task in workflow.tasks:
            assert task.dependencies == []  # Using 'dependencies' not 'depends_on'
