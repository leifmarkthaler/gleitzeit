...
**Methods**:
- `template/render` - Render Jinja2 templates
- `template/execute` - Render and execute as workflow
...
# Run workflows
gleitzeit run workflow.yaml
gleitzeit run workflow.yaml --mode api
gleitzeit run workflow.yaml --mode native

# Submit workflows (API mode)
gleitzeit submit workflow.yaml --priority high
...
- [Hub-Provider Separation](../docs/HUB_PROVIDER_ARCHITECTURE.md)
- [Unified Persistence](../docs/UNIFIED_PERSISTENCE.md)
