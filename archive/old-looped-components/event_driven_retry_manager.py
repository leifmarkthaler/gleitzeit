...
from gleitzeit.core.errors import is_retryable_error, TaskError, ErrorCode, ConfigurationError
...
class EventDrivenRetryManager:
    ...
    def __init__(self, 
        ...
        if not event_bus:
            raise ConfigurationError("EventDrivenRetryManager requires an event bus")
